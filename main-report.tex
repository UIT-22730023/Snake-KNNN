...
\usepackage{diagbox} % Thêm đường gạch chéo
...
\def \AUTHOR{Trần Lê Phú An, Trần Trung Nghĩa, Nguyễn Thị Như Ý}
...
\chapter{HỢP ĐỒNG THÀNH LẬP NHÓM}
\subfile{chapters/chap1-hop_dong_nhom}

\chapter{BÁO CÁO ĐỒ ÁN}
\subfile{chapters/chap2-bao_cao_do_an}

\chapter{ĐÁNH GIÁ QUÁ TRÌNH LÀM VIỆC NHÓM}
\subfile{chapters/chap3-danh_gia_qua_trinh}
